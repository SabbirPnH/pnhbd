              ...
              return (
                <div key={id} data-aos="flip-up" data-aos-duration="1000" className="p-4 md:w-1/3">
                  <div className="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                    <Image width={720} height={400} className="lg:h-48 md:h-36 w-full object-cover object-center rounded-lg" src={image} alt={title} />
                    <div className="p-6">
                      <h1 className="title-font text-lg font-medium text-gray-900 mb-3">{title}</h1>
                      <p className="leading-relaxed mb-3">{description}</p>
                      <Link href={url}><div className="flex items-center flex-wrap cursor-pointer ">
